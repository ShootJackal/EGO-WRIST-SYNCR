...
def _prompt_for_destination_drive() -> Path:
    """Ask the user for a destination drive/path for transfer mode."""
    print()
...
def resolve_root(root_arg: str | None = None) -> Path:
    ...
    3) first external (non-system) drive with NOT UPLOADED/HEAD, LEFT, RIGHT
...
# ═══════════════════════════════════════════════════════════════════
#  FFmpeg / audio helpers  (unchanged core logic)
# ═══════════════════════════════════════════════════════════════════
...
def scan_folder(folder: Path, label: str) -> list[dict]:
    """Scan a camera folder with a progress bar."""
...
# ═══════════════════════════════════════════════════════════════════
#  Interactive launcher  —  the unified menu
# ═══════════════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════════════
#  CLI  (for scripted / advanced usage)
# ═══════════════════════════════════════════════════════════════════
